(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@angular/router'),require('@angular/common'),require('@angular/platform-browser'),require('@angular/forms'),exports, require('@angular/core'), require('@angular/common'), require('@angular/router'), require('rxjs'), require('@angular/platform-browser'), require('rxjs/operators'), require('@angular/forms')) :
    typeof define === 'function' && define.amd ? define('angular-admin-lte', ['@angular/core','@angular/router','@angular/common','@angular/platform-browser','@angular/forms','exports', '@angular/core', '@angular/common', '@angular/router', 'rxjs', '@angular/platform-browser', 'rxjs/operators', '@angular/forms'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ng.core,global.ng.router,global.ng.common,global.ng.platformBrowser,global.ng.forms,global['angular-admin-lte'] = {}, global.ng.core, global.ng.common, global.ng.router, global.rxjs, global.ng.platformBrowser, global.rxjs.operators, global.ng.forms));
}(this, (function (ɵngcc0,ɵngcc1,ɵngcc2,ɵngcc3,ɵngcc4,exports, core, common, router, rxjs, platformBrowser, operators, forms) { 
...
function BreadcrumbsComponent_li_1_a_1_Template(rf, ctx) { if (rf & 1) {
    ...
    var breadcrumb_r1 = ctx_r12.$implicit;
    var first_r2 = ctx_r12.first;
...
function BreadcrumbsComponent_li_1_ng_template_2_Template(rf, ctx) { if (rf & 1) {
    ...
    var first_r2 = ctx_r18.first;
    var breadcrumb_r1 = ctx_r18.$implicit;
    ɵngcc0.ɵɵproperty("ngIf", first_r2);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", breadcrumb_r1.data.breadcrumbs);
    ɵngcc0.ɵɵadvance(1);
...
var _c1 = [[["", "mk-layout-content-before-header", ""]], [["", "mk-layout-content-after-header", ""]], "*"];
var _c2 = ["[mk-layout-content-before-header]", "[mk-layout-content-after-header]", "*"];
var _c3 = ["templateRef"];
...
var _c5 = ["headerElement"];
var _c6 = ["sidebarLeftToggleElement"];
var _c7 = ["sidebarRightToggleElement"];
...
function SidebarLeftComponent_ng_template_6_span_1_Template(rf, ctx) { if (rf & 1) {
    ...
    var item_r6 = ɵngcc0.ɵɵnextContext().item;
    ɵngcc0.ɵɵadvance(1);
...
function SidebarLeftComponent_ng_template_6_a_2_span_4_span_1_Template(rf, ctx) { if (rf & 1) {
    ...
    var rightItem_r15 = ctx.$implicit;
...
function SidebarLeftComponent_ng_template_6_a_2_span_4_Template(rf, ctx) { if (rf & 1) {
    ...
    var item_r6 = ɵngcc0.ɵɵnextContext(2).item;
    ɵngcc0.ɵɵadvance(1);
...
function SidebarLeftComponent_ng_template_6_a_3_span_4_span_1_Template(rf, ctx) { if (rf & 1) {
    ...
    var rightItem_r21 = ctx.$implicit;
...
function SidebarLeftComponent_ng_template_6_ul_4_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("mkCollapseAnimation.start", function SidebarLeftComponent_ng_template_6_ul_4_Template_ul_mkCollapseAnimation_start_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r28); var ctx_r27 = ɵngcc0.ɵɵnextContext(2); return ctx_r27.visibilityStateStart($event); });
...
var _c10 = ["sidebarContentElement"];
...
function AccordionGroupComponent_div_1_5_Template(rf, ctx) { if (rf & 1) {
    ...
    var accordion_r1 = ɵngcc0.ɵɵnextContext().$implicit;
...
function AccordionGroupComponent_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("mkCollapseAnimation.start", function AccordionGroupComponent_div_1_Template_div_mkCollapseAnimation_start_6_listener($event) { ɵngcc0.ɵɵrestoreView(_r12); var accordion_r1 = ctx.$implicit; var ctx_r11 = ɵngcc0.ɵɵnextContext(); return ctx_r11.onCollapseStart($event, accordion_r1); })("mkCollapseAnimation.done", function AccordionGroupComponent_div_1_Template_div_mkCollapseAnimation_done_6_listener($event) { ɵngcc0.ɵɵrestoreView(_r12); var accordion_r1 = ctx.$implicit; var ctx_r13 = ɵngcc0.ɵɵnextContext(); return ctx_r13.onCollapseDone($event, accordion_r1); });
...
var _c11 = ["removeButtonElement"];
function AlertComponent_div_0_button_2_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelementStart(0, "button", 4, 5);
    ɵngcc0.ɵɵtext(2, "\u00D7");
    ɵngcc0.ɵɵelementEnd();
} }
var _c12 = function (a0, a1, a2) { return [a0, a1, a2]; };
function AlertComponent_div_0_Template(rf, ctx) { if (rf & 1) {
    var _r4 = ɵngcc0.ɵɵgetCurrentView();
    ɵngcc0.ɵɵelementStart(0, "div", 1);
    ɵngcc0.ɵɵlistener("mkCollapseAnimation.start", function AlertComponent_div_0_Template_div_mkCollapseAnimation_start_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r4); var ctx_r3 = ɵngcc0.ɵɵnextContext(); return ctx_r3.onCollapseStart($event); })("mkCollapseAnimation.done", function AlertComponent_div_0_Template_div_mkCollapseAnimation_done_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r4); var ctx_r5 = ɵngcc0.ɵɵnextContext(); return ctx_r5.onCollapseDone($event); });
...
var _c13 = ["toggleButtonElement"];
var _c14 = function (a0, a1) { return { "fa-plus": a0, "fa-minus": a1 }; };
...
function BoxComponent_div_0_Template(rf, ctx) { if (rf & 1) {
    var _r12 = ɵngcc0.ɵɵgetCurrentView();
    ɵngcc0.ɵɵelementStart(0, "div", 1);
    ɵngcc0.ɵɵlistener("mkCollapseAnimation.done", function BoxComponent_div_0_Template_div_mkCollapseAnimation_done_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r12); var ctx_r11 = ɵngcc0.ɵɵnextContext(); return ctx_r11.removedDone($event); });
    ɵngcc0.ɵɵtemplate(1, BoxComponent_div_0_div_1_Template, 8, 9, "div", 2);
    ɵngcc0.ɵɵelementStart(2, "div", 3);
    ɵngcc0.ɵɵlistener("mkCollapseAnimation.start", function BoxComponent_div_0_Template_div_mkCollapseAnimation_start_2_listener($event) { ɵngcc0.ɵɵrestoreView(_r12); var ctx_r13 = ɵngcc0.ɵɵnextContext(); return ctx_r13.onCollapseStart($event); })("mkCollapseAnimation.done", function BoxComponent_div_0_Template_div_mkCollapseAnimation_done_2_listener($event) { ɵngcc0.ɵɵrestoreView(_r12); var ctx_r14 = ɵngcc0.ɵɵnextContext(); return ctx_r14.onCollapseDone($event); });
...
var _c15 = [[["mk-box-header"]], [["mk-box-tools"]], [["mk-box-content"]], "*", [["mk-box-footer"]]];
var _c16 = ["mk-box-header", "mk-box-tools", "mk-box-content", "*", "mk-box-footer"];
...
var _c17 = [[["mk-box-header"]], [["mk-box-content"]], "*", [["mk-box-footer"]]];
var _c18 = ["mk-box-header", "mk-box-content", "*", "mk-box-footer"];
...
var _c19 = [[["mk-box-small-header"]], [["mk-box-small-content"]], "*", [["mk-box-small-footer"]]];
var _c20 = ["mk-box-small-header", "mk-box-small-content", "*", "mk-box-small-footer"];
var _c21 = ["toggleElement"];
...
function DropdownComponent_ng_template_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("mkCollapseAnimation.start", function DropdownComponent_ng_template_0_Template_ul_mkCollapseAnimation_start_3_listener($event) { ɵngcc0.ɵɵrestoreView(_r15); var ctx_r14 = ɵngcc0.ɵɵnextContext(); return ctx_r14.onCollapseStart($event); })("mkCollapseAnimation.done", function DropdownComponent_ng_template_0_Template_ul_mkCollapseAnimation_done_3_listener($event) { ɵngcc0.ɵɵrestoreView(_r15); var ctx_r16 = ɵngcc0.ɵɵnextContext(); return ctx_r16.onCollapseDone($event); });
...
var _c22 = [[["mk-input-group-label"]], [["mk-input-group-content"]], [["mk-input-group-addon-left"]], [["mk-input-group-addon-right"]], [["mk-input-group-content"]]];
var _c23 = ["mk-input-group-label", "mk-input-group-content", "mk-input-group-addon-left", "mk-input-group-addon-right", "mk-input-group-content"];
...
function TabsComponent_div_5_1_Template(rf, ctx) { if (rf & 1) {
    ...
    var tab_r16 = ɵngcc0.ɵɵnextContext().$implicit;
...
RoutingService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: RoutingService, factory: function (t) { return RoutingService.ɵfac(t); } });
...
BreadcrumbsModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function BreadcrumbsModule_Factory(t) { return new (t || BreadcrumbsModule)(); }, imports: [[common.CommonModule, router.RouterModule]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(BreadcrumbsModule, { declarations: [BreadcrumbsComponent], imports: [ɵngcc2.CommonModule, ɵngcc1.RouterModule], exports: [BreadcrumbsComponent] }); })();
...
SidebarRightService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: SidebarRightService, factory: function (t) { return SidebarRightService.ɵfac(t); } });
...
HeaderService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: HeaderService, factory: function (t) { return HeaderService.ɵfac(t); } });
...
FooterService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: FooterService, factory: function (t) { return FooterService.ɵfac(t); } });
...
ContentModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function ContentModule_Factory(t) { return new (t || ContentModule)(); }, imports: [[common.CommonModule, router.RouterModule, BreadcrumbsModule]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(ContentModule, { declarations: [ContentComponent], imports: [ɵngcc2.CommonModule, ɵngcc1.RouterModule, BreadcrumbsModule], exports: [ContentComponent] }); })();
...
FooterModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function FooterModule_Factory(t) { return new (t || FooterModule)(); }, imports: [[common.CommonModule]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(FooterModule, { declarations: [FooterComponent, FooterLeftComponent, FooterRightComponent], imports: [ɵngcc2.CommonModule], exports: [FooterComponent, FooterLeftComponent, FooterRightComponent] }); })();
...
HeaderModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function HeaderModule_Factory(t) { return new (t || HeaderModule)(); }, imports: [[common.CommonModule, router.RouterModule]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(HeaderModule, { declarations: [HeaderComponent, HeaderLogoComponent, HeaderLogoMiniComponent], imports: [ɵngcc2.CommonModule, ɵngcc1.RouterModule], exports: [HeaderComponent, HeaderLogoComponent, HeaderLogoMiniComponent] }); })();
...
WrapperService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: WrapperService, factory: function (t) { return WrapperService.ɵfac(t); } });
...
SidebarLeftModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function SidebarLeftModule_Factory(t) { return new (t || SidebarLeftModule)(); }, imports: [[common.CommonModule, router.RouterModule, AnimationsModule]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(SidebarLeftModule, { declarations: [SidebarLeftToggleDirective, SidebarLeftComponent], imports: [ɵngcc2.CommonModule, ɵngcc1.RouterModule, AnimationsModule], exports: [SidebarLeftComponent] }); })();
...
SidebarRightModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function SidebarRightModule_Factory(t) { return new (t || SidebarRightModule)(); }, imports: [[common.CommonModule]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(SidebarRightModule, { declarations: [SidebarRightComponent], imports: [ɵngcc2.CommonModule], exports: [SidebarRightComponent] }); })();
...
WrapperModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function WrapperModule_Factory(t) { return new (t || WrapperModule)(); }, imports: [[common.CommonModule]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(WrapperModule, { declarations: [WrapperComponent], imports: [ɵngcc2.CommonModule], exports: [WrapperComponent] }); })();
...
LayoutModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function LayoutModule_Factory(t) { return new (t || LayoutModule)(ɵngcc0.ɵɵinject(LayoutModule, 12)); }, providers: [RoutingService, WrapperService, SidebarRightService, HeaderService, FooterService], imports: [[common.CommonModule, router.RouterModule], ContentModule, FooterModule, HeaderModule, SidebarLeftModule, SidebarRightModule, WrapperModule] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(LayoutModule, { imports: [ɵngcc2.CommonModule, ɵngcc1.RouterModule], exports: [ContentModule, FooterModule, HeaderModule, SidebarLeftModule, SidebarRightModule, WrapperModule] }); })();
...
ColorService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: ColorService, factory: function (t) { return ColorService.ɵfac(t); } });
...
AccordionModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function AccordionModule_Factory(t) { return new (t || AccordionModule)(); }, imports: [[common.CommonModule, AnimationsModule, ColorModule]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(AccordionModule, { declarations: [AccordionToggleDirective, AccordionHeaderComponent, AccordionContentComponent, AccordionComponent, AccordionGroupComponent], imports: [ɵngcc2.CommonModule, AnimationsModule, ColorModule], exports: [AccordionHeaderComponent, AccordionContentComponent, AccordionComponent, AccordionGroupComponent] }); })();
...
AlertModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function AlertModule_Factory(t) { return new (t || AlertModule)(); }, imports: [[common.CommonModule, AnimationsModule, ColorModule]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(AlertModule, { declarations: [AlertComponent], imports: [ɵngcc2.CommonModule, AnimationsModule, ColorModule], exports: [AlertComponent] }); })();
...
BoxModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function BoxModule_Factory(t) { return new (t || BoxModule)(); }, imports: [[common.CommonModule, AnimationsModule, ColorModule]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(BoxModule, { declarations: [BoxComponent, BoxHeaderDirective, BoxContentDirective, BoxFooterDirective, BoxToolsDirective], imports: [ɵngcc2.CommonModule, AnimationsModule, ColorModule], exports: [BoxComponent, BoxHeaderDirective, BoxContentDirective, BoxFooterDirective, BoxToolsDirective] }); })();
...
BoxInfoModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function BoxInfoModule_Factory(t) { return new (t || BoxInfoModule)(); }, imports: [[common.CommonModule, ColorModule]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(BoxInfoModule, { declarations: [BoxInfoComponent, BoxInfoHeaderDirective, BoxInfoContentDirective, BoxInfoFooterDirective], imports: [ɵngcc2.CommonModule, ColorModule], exports: [BoxInfoComponent, BoxInfoHeaderDirective, BoxInfoContentDirective, BoxInfoFooterDirective] }); })();
...
BoxSmallModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function BoxSmallModule_Factory(t) { return new (t || BoxSmallModule)(); }, imports: [[common.CommonModule, ColorModule]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(BoxSmallModule, { declarations: [BoxSmallComponent, BoxSmallHeaderDirective, BoxSmallContentDirective, BoxSmallFooterDirective], imports: [ɵngcc2.CommonModule, ColorModule], exports: [BoxSmallComponent, BoxSmallHeaderDirective, BoxSmallContentDirective, BoxSmallFooterDirective] }); })();
...
DropdownModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function DropdownModule_Factory(t) { return new (t || DropdownModule)(); }, imports: [[common.CommonModule, AnimationsModule, ColorModule]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(DropdownModule, { declarations: [DropdownComponent, DropdownToggleComponent, DropdownMenuComponent], imports: [ɵngcc2.CommonModule, AnimationsModule, ColorModule], exports: [DropdownComponent, DropdownToggleComponent, DropdownMenuComponent] }); })();
...
ClassService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: ClassService, factory: function (t) { return ClassService.ɵfac(t); } });
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(InputTextModule, { declarations: [InputTextDirective], imports: [ɵngcc2.CommonModule, ColorModule, ɵngcc4.FormsModule], exports: [InputTextDirective] }); })();
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(InputGroupModule, { declarations: [InputGroupComponent, InputGroupLabelDirective, InputGroupAddonLeftDirective, InputGroupAddonRightDirective, InputGroupContentDirective], imports: [ɵngcc2.CommonModule, ColorModule, ɵngcc4.FormsModule], exports: [InputGroupComponent, InputGroupLabelDirective, InputGroupAddonLeftDirective, InputGroupAddonRightDirective, InputGroupContentDirective] }); })();
...
TabsModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function TabsModule_Factory(t) { return new (t || TabsModule)(); }, imports: [[common.CommonModule, ColorModule]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(TabsModule, { declarations: [TabToggleDirective, TabsComponent, TabsHeaderComponent, TabComponent, TabHeaderComponent, TabContentComponent], imports: [ɵngcc2.CommonModule, ColorModule], exports: [TabsComponent, TabsHeaderComponent, TabComponent, TabHeaderComponent, TabContentComponent] }); })();
